...
$(function () {
  ...
  $(".form-check-input").on("change", function (event) {
    if (event.target.checked) {
      ...
      event.target.parentElement.querySelector(".form-check-label").innerText =
        "Enabled";
    } else {
      event.target.parentElement.parentElement
        .querySelector(".badge")
...
// Update Showcase Category Text for CMS
...
function addToSchedule() {
  let url_add_to_schedule =
    "http://localhost:5000/api/sheets/1M4SwxMxOGsJSh_FIZBxktitoQhM2xrbRgQQszrriD1M";
